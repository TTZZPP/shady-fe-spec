---
home: true
heroText: SHADY Front-end coding specification
tagline: 前端编码规范工程化
actions:
  - text: 立刻进入 →
    link: /coding/html.md
...
| 规约 | Lint 工具 | NPM包 |
| -------- | -------- | -------- |
| JavaScript 编码规范 <br/> TypeScript 编码规范  <br/> Node 编码规范   |  [ESLint](https://eslint.org/)   | [shady-fe-eslint-config](https://www.npmjs.com/package/shady-fe-eslint-config) |
...
-   **GitHub**: <https://github.com/TTZZPP/shady-fe-spec>
