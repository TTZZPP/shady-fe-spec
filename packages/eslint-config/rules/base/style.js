...
export default [{
  ...
  rules: {
    ...
    // 类成员之间保留一个空行
    '@stylistic/js/lines-between-class-members': ['off', 'always', { exceptAfterSingleLine: false }],
    ...
    // 在长方法链式调用时进行换行
    '@stylistic/js/newline-per-chained-call': ['warn', { ignoreChainWithDepth: 4 }],
    ...
    // 块的开始和结束不能是空行
    '@stylistic/js/padded-blocks': ['warn', { blocks: 'never', classes: 'never', switches: 'never' }],
